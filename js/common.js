(function () {
  ...
  //表单留言提交
    utils.formSubmitOption = function (e, id, submitType,strings) {
        ...
        if (submitType !== 'stPhone' && submitType !== 'wechat' && submitType !== 'wechat') {
            ...
            switch (submitType) {
                case 'stPhone':
                    if (utils.phoneTest(id)) {
                        alert('恭喜您提交成功');
                        interactive.submitMsgOp(e,{
                            type:'stPhone',
                            value:utils.phoneTest(id),
                            msgInputType:'studentInput',
                            msg:strings
                        });
    ...
    //表单留言提交
    utils.formSubmit = function (e, id, submitType) {
        // var bool=submitType=='stPhone'||'wechat';
        // console.log(bool)
        if (submitType !== 'stPhone' && submitType !== 'wechat' && submitType !== 'wechat') {
            alert('提交方式错误，请选择stPhone或wechat');
    ...
    //倒计时 起始和截止倒计时
    utils.endTime = function (startYear, startMonth, startDay, endYear, endMonth, endDay) {
